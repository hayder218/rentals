    ...
    return (
        <MainLayout>
            ...
            <div className="mb-8">
                ...
                <h2 className="text-3xl font-bold tracking-tight mt-4">Edit Vehicle</h2>
                <p className="text-muted-foreground mt-1">Update details for {car.make} {car.model}.</p>
            </div>
                ...
                <CardContent>
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">Update the odometer reading after rentals or maintenance.</p>
                        </div>
